      ...
      <div className="container">
        <div className="header__content">
          <nav className="header__navbar">
            <ul className="header__navbar__list left">
            ...
            <ul className="header__navbar__list right">
              <li className="header__navbar__item notify">
                <span>Thông báo</span>
                <div className="header__navbar__item__notify__content"></div>
              </li>
              <li className="header__navbar__item">Trợ giúp</li>
              <li className="header__navbar__item">Đăng nhập</li>
              <li className="header__navbar__item">Đăng kí</li>
            </ul>
          </nav>
          <div className="header-width-search__wrapper">
            <div className="header-width-search__wrapper__logo">
              <Link to="/">
                <svg version="1.1" viewBox="0 0 244 50" className="header__logo__img">
                  <path
                    pid="0"
            ...
            <div className="header-width-search__wrapper__search__box">
            ...
            <div className="header-width-search__wrapper__cart">
              <Link to="cart">
                <div className="header__cart__box" data-duration="2">
